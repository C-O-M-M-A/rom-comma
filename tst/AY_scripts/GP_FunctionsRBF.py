...
def run_gp(store: Store, gp_name: str = "ARD", model_name: str = "ARD", optimize: bool = True, test: bool = True,
    ...
    params = model.base.GP.Parameters(kernel=kernel_parameters, e_floor=-1.0E-3, f=1, e=0.1, log_likelihood=None)
...
if __name__ == '__main__':
    ...
    STORE_NAME = "Max_T_TR_Data-5folds"
    STORE = store_and_fold("Max_T_TR_Data.csv", STORE_NAME, 5, is_split=True)
    # STORE = Store(BASE_PATH / "Max_T_TR_Data")
